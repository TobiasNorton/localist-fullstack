      ...
      profiles: all_profiles_in_db.map do |profile|
        {
          ...
          picture_url: profile.picture.attached? && url_for(profile.picture_auto_orient)
      ...
      profiles: all_linked_profiles.map do |profile|
        {
          ...
          latitude: profile.latitude,
          longitude: profile.longitude,
          picture_url: url_for(profile.picture_auto_orient)
        }
      end
    }
  end
  ...
  def my_profile
    ...
    json = {
      profile: {
        ...
        picture_url: url_for(current_profile.picture_auto_orient),
